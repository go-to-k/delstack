...
func (m *MockIS3Vectors) CheckVectorBucketExists(ctx context.Context, vectorBucketName *string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckVectorBucketExists", ctx, vectorBucketName)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIS3VectorsMockRecorder) CheckVectorBucketExists(ctx, vectorBucketName any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckVectorBucketExists", reflect.TypeOf((*MockIS3Vectors)(nil).CheckVectorBucketExists), ctx, vectorBucketName)
}
