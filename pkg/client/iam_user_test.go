...
func TestIamUser_CheckUserExists(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			iamUserClient := NewIamUser(client)

			output, err := iamUserClient.CheckUserExists(tt.args.ctx, tt.args.userName)
...
func TestIamUser_DetachUserPolicies(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DetachUserPolicies(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
...
func TestIamUser_DeleteUserInlinePolicies(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteUserInlinePolicies(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeactivateAndDeleteMFADevices(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeactivateAndDeleteMFADevices(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteAccessKeys(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteAccessKeys(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteLoginProfile(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteLoginProfile(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteSigningCertificates(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteSigningCertificates(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteSSHPublicKeys(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteSSHPublicKeys(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteServiceSpecificCredentials(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteServiceSpecificCredentials(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_RemoveUserFromGroups(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.RemoveUserFromGroups(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
...
func TestIamUser_DeleteUser(t *testing.T) {
	SleepTimeSecForIam = 1
	type args struct {
		ctx                context.Context
		userName           *string
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = iamUserClient.DeleteUser(tt.args.ctx, tt.args.userName)
			if (err != nil) != tt.wantErr {
				t.Errorf("error = %#v, wantErr %#v", err, tt.wantErr)
				return
			}
