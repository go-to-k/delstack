...
//
//	mockgen -source=operator_manager.go -destination=operator_manager_mock.go -package=operation -write_package_comment=false
package operation
...
func (mr *MockIOperatorManagerMockRecorder) DeleteResourceCollection(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIOperatorManagerMockRecorder) SetOperatorCollection(stackName, stackResourceSummaries any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
