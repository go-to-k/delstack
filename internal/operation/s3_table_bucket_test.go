...
func TestS3TableBucketOperator_DeleteS3TableBucket(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "delete table bucket failure for list tables errors",
			args: args{
				ctx:            context.Background(),
				tableBucketArn: aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"),
			},
			prepareMockFn: func(m *client.MockIS3Tables) {
				...
				m.EXPECT().ListTablesByPage(gomock.Any(), aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"), aws.String("Namespace"), nil).Return(nil, fmt.Errorf("ListTablesByPageError"))
			},
		...
		{
			name: "delete table bucket successfully for ListNamespacesByPage with zero length",
			args: args{
				ctx:            context.Background(),
				tableBucketArn: aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"),
			},
		...
		{
			name: "delete table bucket failure for ListNamespacesByPage with zero length",
			args: args{
				ctx:            context.Background(),
				tableBucketArn: aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"),
			},
		...
		{
			name: "delete table bucket successfully if several loops are executed for ListNamespacesByPage",
			args: args{
				ctx:            context.Background(),
				tableBucketArn: aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"),
			},
			prepareMockFn: func(m *client.MockIS3Tables) {
				...
				m.EXPECT().ListNamespacesByPage(gomock.Any(), aws.String("arn:aws:s3tables:us-east-1:123456789012:bucket/test"), aws.String("ContinuationToken")).Return(
					&client.ListNamespacesByPageOutput{
						Namespaces: []types.NamespaceSummary{
							{
								Namespace: []string{"Namespace2"},
